...
| **Success (Glucosa Óptima)**| `#2A9D8F` | Valores dentro del rango normal (70-140 mg/dL) |
| **Warning (Precaución)** | `#E9C46A` | Valores fuera de rango leve |
| **Danger (Alerta Hiper/Hipo)**| `#E76F51` | Valores críticos (<70 o >180 mg/dL) |

---

## 🔤 3. Tipografía
- **Principal:** Inter / Roboto
- **Headings:** Outfit / Montserrat
- **Pesos estándar:** Regular (400), Medium (500), SemiBold (600), Bold (700)

---

## 📁 4. Recursos y Assets
- Los logos e isotipos oficiales se encuentran en la carpeta [`design/logo/`](logo/).
